...
import skills from './skills/skills'; // Import your skills data
  ...
  return (
    <div className="min-h-screen bg-base-100 text-base-content p-8">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
        {/* Photo Placeholder */}
        <div className="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden bg-base-200 flex items-center justify-center">
          <Image
            src="/me.jpeg" // Replace with your photo path
            alt="Your Name"
            width={256}
            height={256}
