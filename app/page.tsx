  ...
  return (
    <div className="min-h-screen bg-base-100 text-base-content xs:p-6 md:p-6 lg:p-68 mt-20">
      ...
      <div className="text-primary-content p-8 rounded-lg mb-12">
        ...
        <p className="text-lg">
          I partner with teams to navigate market complexities and build data-driven strategies for investment, policy, and growth. If you're looking for clarity in emerging markets, let's connect.
        </p>
      </div>
